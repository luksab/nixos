{ lib, stdenv, fetchurl, patchelf, makeDesktopItem, alsa-lib, at-spi2-atk
, at-spi2-core, atk, cups, dbus, expat, fontconfig, freetype, glib, harfbuzz
, libdrm, libgcrypt, libglvnd, libkrb5, libpulseaudio, libsecret, udev, libxcb
, libxkbcommon, lshw, mesa, nspr, nss, pango, zlib, libX11, libXcomposite
, libXcursor, libXdamage, libXext, libXfixes, libXi, libXrandr, libXrender
, libXtst, libxshmfence, xcbutil, xcbutilimage, xcbutilkeysyms
, xcbutilrenderutil, xcbutilwm, p7zip, wayland, enableWayland ? false }:
...
in stdenv.mkDerivation rec {
  ...
  libPath = lib.makeLibraryPath buildInputs + ":$out/opt/Webex/lib"
    + ":$out/opt/Webex/bin";
